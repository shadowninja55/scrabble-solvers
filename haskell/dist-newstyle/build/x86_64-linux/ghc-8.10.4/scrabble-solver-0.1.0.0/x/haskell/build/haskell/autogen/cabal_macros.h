...
/* package scrabble-solver-0.1.0.0 */
#ifndef VERSION_scrabble_solver
#define VERSION_scrabble_solver "0.1.0.0"
#endif /* VERSION_scrabble_solver */
#ifndef MIN_VERSION_scrabble_solver
#define MIN_VERSION_scrabble_solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_scrabble_solver */
...
#define CURRENT_COMPONENT_ID "scrabble-solver-0.1.0.0-inplace-haskell"
